...
## 7. 允许修改路径
批准的外置工作根、`src/era100x/data/full_build/`、`tests/data/full_build/`、`scripts/run_stage1_full_build.py`、轻量Manifest/Catalog摘要、Task Validation/Traceability。v1.2允许完全重复的可审计确定性去重、BTC/ETH双worker隔离并行与不改变逻辑hash语义的热路径优化。
## 8. 禁止修改路径
