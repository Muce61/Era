...
This Task implements the ADR-S2-005 priority and merge arbitration, supersession and complete member-source retention. No downstream outcome may affect arbitration.
