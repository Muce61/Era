...
只实现并验证“条件随机基线”及其直接契约、测试和追踪；允许为该单一能力增加最小审计证据。
...
- 允许修改路径：`src/era100x/research/stage_2/baselines/conditional/`、`tests/research/stage_2/baselines/conditional/`，以及本Task validation/TRACEABILITY。禁止修改Stage 1实现/数据、\`docs/spec/**\`和Stage 3+。
