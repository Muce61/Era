...
| Stage 2 | 1.2 | IN_PROGRESS | Stage 1 PASSED + VALID data baseline | NONE | S2_T10_V1_8_CR_2026_009_RELEASE_HARDENING_IN_PROGRESS | CR-2026-009 is APPROVED for bounded Run A release integrity and Runtime V2 operator-surface corrections. Run A remains 9508/9508 complete and unpublished until hardening, new append-only release authority and fault-injection gates pass. No Run B exists; S2-T19 and S2-T01～S2-T09 remain PASSED; Groups 2～4 remain DRAFT and unexecuted |
