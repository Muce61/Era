...
| Stage 2 | 1.2 | IN_PROGRESS | Stage 1 PASSED + VALID data baseline | NONE | GROUP_1_S2_T10_DUAL_FULL_BUILD_IN_PROGRESS | CR-2026-004 RESOLVED/IMPLEMENTED/VALIDATED; S2-T09 v1.4 PASSED and S2-T10 v1.5 IN_PROGRESS; pre-run gates precede any new run; failed and invalidated evidence remains retained; Groups 2～4 remain DRAFT and unexecuted |
