...
| Stage 2 | 1.2 | IN_PROGRESS | Stage 1 PASSED + VALID data baseline | NONE | NOT_READY_FOR_FULL_REEXECUTION | Formal Run A is PUBLISHED/PASS and immutable. S2-T19 and S2-T01～S2-T09 remain PASSED. CR-2026-014 preserves exact July semantics and passes repository quality gates, but achieves 2.18x versus the approved 4x performance gate and 1.73 versus 2.5 average cores. S2-T10 v1.12 remains blocked; no new Authority or replacement Run B was created. Groups 2～4 remain DRAFT and unexecuted. |
