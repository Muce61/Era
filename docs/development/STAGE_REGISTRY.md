...
| Stage 2 | 1.2 | IN_PROGRESS | Stage 1 PASSED + VALID data baseline | NONE | GROUP_1_S2_T10_V1_7_RELEASE_RECOVERY_IN_PROGRESS | CR-2026-006 approves release-tool/generator-version separation and release-only recovery of the fixed 9508/9508 v1.6 Run A; Run B must remain a fresh build. S2-T19 and S2-T01～S2-T09 remain PASSED; Groups 2～4 remain DRAFT and unexecuted |
