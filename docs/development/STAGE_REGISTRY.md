...
| ----- | ------------ | ------ | ------------ | -------- | -------- | ----- |
| Stage 0 | 1.0 | READY_FOR_FINAL_APPROVAL | NONE | NONE | VALIDATED_PENDING_FINAL_APPROVAL | 13 Tasks PASSED; Stage validation PASS; final PASSED and baseline require human approval |
