...
| Stage 2 | 1.2 | APPROVED | Stage 1 PASSED + VALID data baseline | NONE | GROUP_1_RECOVERY_AUTHORIZED | CR-2026-003 APPROVED; S2-T10 v1.4 REOPENED only for Catalog-authoritative archive-path correction and new deterministic runs; S2-T19 and S2-T01～S2-T09 remain PASSED; failed run remains unpublished; Groups 2～4 remain DRAFT and unexecuted |
