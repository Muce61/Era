...
| Stage 2 | 1.2 | BLOCKED | Stage 1 PASSED + VALID data baseline | NONE | GROUP_1_BLOCKED_CR_2026_005 | CR-2026-004 remains RESOLVED; the first v1.5 Run A failed unpublished at BTC PRICE finalization on two same-identity/different-payload groups. CR-2026-005 awaits human choice before any code change or new run; S2-T19 and S2-T01～S2-T09 remain PASSED; Groups 2～4 remain DRAFT and unexecuted |
