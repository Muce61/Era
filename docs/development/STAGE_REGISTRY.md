...
| Stage 2 | 1.2 | IN_PROGRESS | Stage 1 PASSED + VALID data baseline | NONE | BLOCKED_PENDING_CR_2026_015_VALIDATION | Formal Run A is PUBLISHED/PASS and immutable. S2-T19 and S2-T01～S2-T09 remain PASSED. The latest Run B sealed all 80,784 V2 partitions but failed unpublished at final component packing due to a producer/consumer sort-key mismatch; 19/19 packed artifacts are physically unique. CR-2026-015 permits a corrected packer and audited monthly adoption into one new run. Groups 2～4 remain DRAFT and unexecuted. |
