...
| Stage 2 | 1.2 | IN_PROGRESS | Stage 1 PASSED + VALID data baseline | NONE | READY_FOR_CR_2026_011_IMPLEMENTATION | Formal Run A is PUBLISHED/PASS and immutable. CR-2026-010 compatibility and Authority gates passed, but the terminal successor Run B failed unpublished at the first BTC Foundation RSS gate with zero completed/staging/published output. CR-2026-011 is APPROVED only for profiled row-group streaming, explicit release and separate Arrow/current-RSS/baseline-relative gates. S2-T19 and S2-T01～S2-T09 remain PASSED; S2-T10 v1.9 is IN_PROGRESS; Groups 2～4 remain DRAFT and unexecuted. |
