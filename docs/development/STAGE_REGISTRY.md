...
| Stage 2 | 1.2 | IN_PROGRESS | Stage 1 PASSED + VALID data baseline | NONE | READY_FOR_CR_2026_011_AUTHORITY_REFREEZE_AND_REPLACEMENT_RUN_B | Formal Run A is PUBLISHED/PASS and immutable. The terminal successor Run B failed unpublished at the first BTC Foundation RSS gate with zero completed/staging/published output. CR-2026-011 row-group streaming, explicit phase release and separate 1 GiB Arrow / 3 GiB current RSS / 1 GiB baseline-delta gates passed real-data profiles and all quality gates. The failed run must be invalidated append-only; one final-code Authority and unique replacement Run B are conditionally authorized. S2-T19 and S2-T01～S2-T09 remain PASSED; S2-T10 v1.9 is IN_PROGRESS; Groups 2～4 remain DRAFT and unexecuted. |
