...
| Stage 2 | 1.2 | IN_PROGRESS | Stage 1 PASSED + VALID data baseline | NONE | S2_T15_STOPPED | S2-T19 and S2-T01～S2-T14 are PASSED. S2-T15 has no formal published research result and is STOPPED under OQ-S2-009/010/011; only read-only audit/verification is allowed. SRP-S2-001 exemptions are approved but not executable. S2-T16～S2-T18 and S2-T20 remain DRAFT_NOT_APPROVED; Groups 2～4 remain unexecuted; Stage 3 remains locked. |
