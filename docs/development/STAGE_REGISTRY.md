...
| Stage 2 | 1.2 | BLOCKED | Stage 1 PASSED + VALID data baseline | NONE | GROUP_1_FAILED_UNPUBLISHED | S2-T19 and S2-T01～S2-T09 PASSED; S2-T10 failed in unpublished full run after 2376/9504 partitions because the Trades physical path omitted `archive=YYYY-MM`; CR-2026-003 READY_FOR_APPROVAL; Groups 2～4 remain DRAFT and unexecuted |
