...
| Stage 2 | 1.2 | IN_PROGRESS | Stage 1 PASSED + VALID data baseline | NONE | GROUP_1_S2_T10_V1_6_DUAL_FULL_RUN_AUTHORIZED | CR-2026-005 is RESOLVED after PASS validation; Muce authorized a new locked Execution Manifest and fresh independent Run A / Run B builds. Failed v1.5 Run A remains unpublished and no old staging may be reused; S2-T19 and S2-T01～S2-T09 remain PASSED; Groups 2～4 remain DRAFT and unexecuted |
