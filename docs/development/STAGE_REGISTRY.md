...
| Stage 2 | 1.2 | IN_PROGRESS | Stage 1 PASSED + VALID data baseline | NONE | BLOCKED_PENDING_CR_2026_014_VALIDATION | Formal Run A is PUBLISHED/PASS and immutable. S2-T19 and S2-T01～S2-T09 remain PASSED. S2-T10 v1.12 is reopened only for CR-2026-014 Group-1 execution optimization. The stopped Run B retains both PASSED Foundation Tasks, eight BTC PRICE months and zero publication; it cannot resume under changed code or contribute Group-1 output. Correctness, performance and quality gates must pass before a new Authority or run. Groups 2～4 remain DRAFT and unexecuted. |
