...
| Stage 2 | 1.2 | IN_PROGRESS | Stage 1 PASSED + VALID data baseline | NONE | GROUP_1_READY_FOR_S2_T10_RECOVERY | CR-2026-004 L2 validation PASS; S2-T09 v1.4 PASSED and S2-T10 v1.5 APPROVED_FOR_REEXECUTION; no recovery Manifest/run created yet; failed run remains unpublished; Groups 2～4 remain DRAFT and unexecuted |
