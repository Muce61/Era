...
| Stage 1 | 1.1 | IN_PROGRESS | Stage 0 PASSED | NONE | PARTIALLY_EXECUTED | CR-2026-001 Trade Identity v2 approved; affected Tasks reopened/regressed; prior 134/162 run INVALIDATED and unpublished; S1-T14 v1.5 awaits fresh main-based run; S1-T15 DRAFT |
