...
Stage 2 is `IN_PROGRESS / S2_T12_VALIDATED_AWAITING_HUMAN_ACCEPTANCE`. S2-T19 and S2-T01～S2-T11 are PASSED;
...
rows. CR-2026-022 automatic Web-UI observability remains awaiting human approval, so S2-T12 awaits
final human acceptance. S2-T13 through S2-T20 remain `DRAFT_NOT_APPROVED`, and Stage 3 remains locked.
...
| Historical price-only path metrics | S2-T12 v1.3 | H1/H2 MFE/MAE, Time-to-Activation proxy and Time-since-MFE; 1,065,416 rows; Run/Verify PASS; no PnL/return/first-passage | VALIDATED / AWAITING HUMAN ACCEPTANCE; UI BLOCKED ON CR-2026-022 |
