...
| Same-stratum non-event placebo | S2P14-T17 v1.0 | verified T16 pool; one fake event per matched source path; group-unique fake events; five outcome-blind controls; frozen L0-L4; 30 H2 cells reused; no bootstrap/CI/FDR | THIRD PREFIX STOPPED AFTER AUDIT / NO OUTCOME READ / PATH IDENTITY FIX VALIDATING |
...
| Placebo | S2P14-T17 | Plan v1.4, CR-2026-046 and ADR-S2-022; H2 historical placebo evidence only | AUDIT-ONLY PREFIX BLOCKED / NO OUTCOME READ / NEW COMMIT-BOUND SUCCESSOR GATED |
