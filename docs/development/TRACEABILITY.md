...
| Same-stratum non-event placebo | S2P14-T17 v1.0 | verified T16 pool; one fake event per matched source slot; group-unique fake events; five outcome-blind controls; frozen L0-L4; 30 H2 cells reused; no bootstrap/CI/FDR | IMPLEMENTATION READY / 786 TESTS PASS / FORMAL RUN COMMIT-BOUND APPROVAL REQUIRED |
...
| Placebo | S2P14-T17 | Plan v1.4, CR-2026-046 and ADR-S2-022; H2 historical placebo evidence only | IMPLEMENTATION READY / SOURCE AUDIT AND UI PASS / FORMAL RUN GATED |
