...
| Catalog object-count observation correction | S2-T10 v1.13 | DRAFT CR-2026-017; remove only the CR-2026-013-superseded Catalog count hard gate; real 201-object publisher regression; validation `docs/development/validations/stage_2/CR-2026-017.md` | DRAFT / CANDIDATE 211 OF 211 PASS / NEW SUCCESSOR NOT AUTHORIZED |
