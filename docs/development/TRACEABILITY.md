...
Stage 2 is `IN_PROGRESS / S2_T10_AND_GROUP_1_PASSED / S2_T11_FULL_OUTPUT_AUTHORIZED`. S2-T19 and S2-T01～S2-T10 are PASSED;
...
human-approved; its fixture capability and full-output runner are implemented, while the formal
full run and final validation remain pending. S2-T12 through S2-T20 remain `DRAFT_NOT_APPROVED`,
...
| Historical H1/H2 path extraction | S2-T11 v1.3 | `paths/extraction`; approved lossless source-slice CLI, UTC windows, v2 order, canonical identity, conflict/gap/lineage, resume/verify and receipts; `validations/stage_2/S2-T11.md` | CAPABILITY PASS / FULL OUTPUT AUTHORIZED / EXECUTION PENDING |
