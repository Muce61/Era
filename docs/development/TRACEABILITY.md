...
Stage 2 is `APPROVED / GROUP_1_RECOVERY_AUTHORIZED`. S2-T19 and S2-T01～S2-T09 remain PASSED. Muce approved CR-2026-003 and S2-T10 v1.4 reopening solely for Catalog/Manifest-authoritative archive-path resolution, regression and two new deterministic full runs. Failed run `stage2-g1-full-a-20260716-4c15e46` remains FAILED_UNPUBLISHED and is not reusable. Groups 2～4 remain DRAFT and were not executed.
...
| Registry-driven full candidate generation; BTC/ETH, setup/context and variants separate | S2-T10 v1.4 | CR-2026-003 approved; archive-path repair and entirely new full runs required; prior failure retained in `validations/stage_2/S2-T10.md` | REOPENED |
