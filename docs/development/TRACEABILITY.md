...
| Same-stratum non-event placebo | S2P14-T17 v1.0 | verified T16 pool; one fake event per matched source path; group-unique fake events; five outcome-blind controls; frozen L0-L4; 30 H2 cells reused; no bootstrap/CI/FDR | FINAL ENGINEERING/VERIFY PASS / 412,021 MATCHED / 1,806 UNMATCHED / DESCRIPTIVE ONLY |
...
| Lifecycle dual-track repair and solo successor chain | S2P110-T11–T20 v1.1 | unchanged Trades/OHLC split and H2 contracts; fixed production builder derives twelve rule-labelled bindings; CR-2026-043 exact-key supplement Acceptance is self-hash-bound inside the source audit and now injected directly by the T11 `inputs.lock` Task context without ambient environment variables; real `BTCUSDT/2022-03-01` supplement Parquet read-back; one full-period inputs lock; fixed ten-handler registry; append-only event ledger and Task attempts; commit/input-lock-bound Authority-before-Run; one final Manifest/Verify and atomic publication | MINIMAL RUNTIME REPAIR VALIDATED / NEW CLEAN COMMIT AND PREPARE PENDING / PRIOR RUN TERMINAL FAILED / STAGE 3 LOCKED |
...
| Placebo | S2P14-T17 | Plan v1.4, CR-2026-046 and ADR-S2-022; H2 historical placebo evidence only | FINAL FORMAL RUN PASS / INDEPENDENT VERIFY PASS / CLUSTERING BOOTSTRAP PENDING |
| Cluster ownership and cluster bootstrap CI | S2P15-T18 | Plan v1.5, CR-2026-047 and ADR-S2-023; BTC/ETH-separated UTC-week resampling; statistical evidence only | FINAL FORMAL RUN / 10,329 CLUSTER ROWS / 54,720 SUMMARIES / 96 FDR FAMILIES / VERIFY PASS |
| Evidence synthesis and final-human-gate preparation | S2P16-T19 | Plan v1.6, CR-2026-048 and ADR-S2-024; deterministic H2/H3 gate rows, parameter landscape, frequency/waiting projection and evidence cards | FORMAL RUN PASS / 28 GATES / 3,420 LANDSCAPE ROWS / VERIFY PASS / FINAL HUMAN GATE PENDING |
| Final acceptance package and deterministic evidence-card reporting | S2P17-T20 | Plan v1.7, CR-2026-049 and ADR-S2-025; canonical JSON content Hash, blind event-card selection and non-promoting NO-GO closure | FORMAL RUN PASS / 28 GATES / 3,420 LANDSCAPE / 14 FREQUENCY / 6 REAL CARDS / VERIFY PASS / STAGE 3 LOCKED |
| Historical Stage 2 acceptance draft | S2-T20 v1.2 | archival task identity only; cannot authorize or override Plan v1.7 | ARCHIVAL DRAFT / NOT AUTHORITY |
