...
separate BTC/ETH H1/H2 counts and 16/16 checks from immutable evidence. S2-T12 still awaits final
human acceptance. S2-T13 through S2-T20 remain `DRAFT_NOT_APPROVED`, and Stage 3 remains locked.
...
| Historical price-only path metrics | S2-T12 v1.3 | H1/H2 MFE/MAE, Time-to-Activation proxy and Time-since-MFE; 1,065,416 rows; Run/Verify/UI PASS; no PnL/return/first-passage | VALIDATED / AWAITING HUMAN ACCEPTANCE; CR-2026-022 UI PASS |
