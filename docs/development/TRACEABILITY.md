...
| Same-stratum non-event placebo | S2P14-T17 v1.0 | verified T16 pool; one fake event per matched source slot; group-unique fake events; five outcome-blind controls; frozen L0-L4; 30 H2 cells reused; no bootstrap/CI/FDR | FIRST AUTHORITY SEALED / RUN NOT CREATED / STRICT JSON READBACK FIXED / SUCCESSOR APPROVAL REQUIRED |
