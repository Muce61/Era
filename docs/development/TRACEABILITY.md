...
Stage 2 is `IN_PROGRESS / S2_T13_V1_3_APPROVED_IMPLEMENTED_AWAITING_FORMAL_RUN`. S2-T19 and S2-T01～S2-T12 are PASSED;
...
S2-T13 v1.3 full-output and automatic read-only UI scope. The implementation is ready for a formal
Authority and full Run; no formal result exists yet. S2-T14 through S2-T20 remain
...
| Historical first-passage labels | S2-T13 v1.3 | strict H1/H2 TARGET_FIRST/STOP_FIRST/EXPIRED/AMBIGUOUS; 30 target/stop combinations per frozen Episode timing; append-only full runner/Verify/UI; no PnL/ROUND_SUCCESS/bounds | APPROVED / IMPLEMENTED / AWAITING FORMAL RUN |
