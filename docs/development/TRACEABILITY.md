...
Stage 2 is `IN_PROGRESS / S2_T12_APPROVED_IN_PROGRESS`. S2-T19 and S2-T01～S2-T11 are PASSED;
...
timing evidence; S2-T13 through S2-T20 remain `DRAFT_NOT_APPROVED`, and Stage 3 remains locked.
...
| Historical price-only path metrics | S2-T12 v1.3 | H1/H2 MFE/MAE, Time-to-Activation proxy and Time-since-MFE; no PnL/return/first-passage | APPROVED / IN PROGRESS |
