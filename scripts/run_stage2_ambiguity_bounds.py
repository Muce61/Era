#!/usr/bin/env python3
"""Approved S2-T14 v1.3 historical ambiguity-distribution CLI."""
...
from era100x.research.stage_2.labels.ambiguity.full_run import (
    RUNS_ROOT,
...
def main() -> int:
    ...
    if args.mode == "preflight":
        ...
        result = {
            ...
            "expected_distribution_count": authority["expected_distribution_count"],
